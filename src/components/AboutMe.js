  ...
  return (
    <section className="isolate overflow-hidden bg-white px-6 lg:px-8">
      <div className="relative mx-auto max-w-2xl py-24 sm:py-32 lg:max-w-4xl">
        <div className="absolute top-0 left-1/2 -z-10 h-[50rem] w-[90rem] -translate-x-1/2 bg-[radial-gradient(50%_100%_at_top,theme(colors.indigo.100),white)] opacity-20 lg:left-36" />
...
// ORIGINAL CODE PRIOR TO IMPLEMENTING TAILWIND
// function AboutMe() {
//   return (
//    <div>

//     <h2>My name is Carter Matschek, and I decided to change my occupation after thirteen years working as a music educator.
//         I am seeking a job in software development and am currently acquiring new knowledge and skills in full-stack coding.
//         I am a team player who communicates and keeps an open mind.
//         My prior experience in education and my ability to learn new things quickly makes me a great candidate for a future
//         on your software team. I look forward to a long and prosperous new career in the field.</h2>
